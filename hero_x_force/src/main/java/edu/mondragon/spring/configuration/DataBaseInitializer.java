...
public class DataBaseInitializer {
	...
	private void insertValuesInDB() {
		...
		Ability ability_3 = new Ability("Battle Fury", "Deals more damage if the hero also attacked in the previous turn.");
		abilityService.addAbility(ability_3);
		
		Ability ability_4 = new Ability("Illumination", "Deals much more damage if the hero also attacked the same enemy in the previous turn.");
		abilityService.addAbility(ability_4);
		
		Ability ability_5 = new Ability("Backstab", "Deals much more damage if the hero attacks an enemy who is attacking another hero in that turn.");
		abilityService.addAbility(ability_5);
		
		Ability ability_6 = new Ability("Traveler's Call", "Defending causes magical spirits to appear. They increase Magic Attack and Speed and gain more power with time.");
		abilityService.addAbility(ability_6);
		
		Ability ability_7 = new Ability("Monado Foresight", "The team knows the next move of the enemy before choosing its own move.");
		abilityService.addAbility(ability_7);
		
		Ability ability_8 = new Ability("Triforce of Courage", "Increases all stats when another team member gets defeated.");
		...
		Ability ability_10 = new Ability("Triforce of Power", "Starts with a buff on Attack and Magic Attack that loses power with damage.");
		...
		Ability ability_16 = new Ability("Spear of Justice", "Can transform into Undyne the Undying when defeated if there is still an ally in the battle.");
		abilityService.addAbility(ability_16);

		Ability ability_17 = new Ability("True Heroine", "Gets increased stats while there is still an ally in the battle.");
		...
		Ability ability_19 = new Ability("Holy Mantle", "Automatically negates one hit of damage. It recovers after the end of the next turn.");
		abilityService.addAbility(ability_19);
		
		Ability ability_20 = new Ability("Dimensional Tears", "Gets random health recovers or stat increases during the battle. Can randomly dodge attacks.");
