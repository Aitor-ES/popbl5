      ...
      <div class="row">
        <div class="col align-self-start">
          <c:choose>
            ...
            <c:otherwise>
              <h2>${user.username}<spring:message code="profile.subTitle"/></h2>
            </c:otherwise>
          </c:choose>
        </div>
        <div class="col-2">
         <a class="btn btn-primary" href="${pageContext.request.contextPath}/profile/edit" role="button"><spring:message code="action.edit"/></a> 
        </div>
      </div>
